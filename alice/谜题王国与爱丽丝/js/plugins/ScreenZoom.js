...
/*:zh
 * @target MZ
 * @plugindesc [Ver1.1.1] 以玩家或指定事件为中心放大画面
 * @author Sasuke KANNAZUKI
 *
 * @command set
 * @text 开始缩放
 ...
 * 本插件适用于 RPG Maker MZ。
 *
 * 本插件可让画面以“玩家”或“指定事件”为中心进行放大（缩放）。
 *
 * 【概要】
 * 缩放效果通过插件命令设置完成。
 * 若将“缩放所需帧数”设为 1，则画面会立即放大。
 * 通过设置偏移量（OffsetX、OffsetY）可调整放大中心位置。
 *
 * 【注意】
 * 缩放结束时请务必调用“重置缩放”命令，
 * 否则可能导致图片显示层级出现异常。
