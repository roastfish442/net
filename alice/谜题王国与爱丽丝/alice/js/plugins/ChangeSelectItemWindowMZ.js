...
/*:zh
 * @target MZ
 * @plugindesc 修改“选择物品”窗口的各种显示设置。
 * @author Sasuke KANNAZUKI
 *
 * @param Switch ID
 * @text 启用开关 ID
 * @desc 仅当此开关为 ON 时，本插件设置才会生效。
 * @type switch
 * @default 1
 *
 * @param Max Columns
 * @text 最大列数
 * @desc 窗口中每行的最大列数。系统默认值为 2。
 * @type number
 * @min 1
 * @default 1
 *
 ...
 * 该插件可以修改“选择物品”事件命令中弹出的物品选择窗口的位置、大小与行列数。
 *
 * 【概要】
 * 当指定的开关为 ON 且执行“选择物品”命令时，
 * 物品选择窗口将按照插件中设定的参数显示。
 *
 * 【插件命令】
 * 可通过插件命令动态更改窗口的属性，
